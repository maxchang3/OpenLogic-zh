...
\begin{defn}[双模拟]
设 $M_1 = \tuple{W_1, R_1, V_1}$ 与 $M_2 = \tuple{W_2, R_2, V_2}$ 是两个关系模型。并设 $\mathcal{R} \subseteq W_1 \times W_2$ 是一个二元关系。称 $\mathcal{R}$ 是一个\emph{双模拟}，若对每个 $\tuple{w_1, w_2} \in \mathcal{R}$ 都有：
