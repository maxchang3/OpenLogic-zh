...
\begin{defn}
  认知语言的\emph{!!^{formula}}归纳定义如下：
  \begin{enumerate}
  \tagitem{prvFalse}{$\lfalse$ 是原子!!{formula}。}{}

  \tagitem{prvTrue}{$\ltrue$ 是原子!!{formula}。}{}

  \item 每个命题变元 $\Obj p_i$ 都是（原子）
  !!{formula}。

  \tagitem{prvNot}{若 $!A$ 是!!a{formula}，则 $\lnot !A$ 是
  !!a{formula}。}{}
  ...
  \item 若 $!A$ 是!!a{formula}且 $a \in G$，则 $\Knows_a !A$ 是
  !!a{formula}。

  \item 若 $!A$ 和 $!B$ 都是!!{formula}，则 $[!A] !B$ 是!!a{formula}。
