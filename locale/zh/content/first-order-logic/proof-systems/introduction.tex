...
\end{enumerate}
上式的「仅当」方向称为\emph{可靠性}。若!!{derivability}保证了衍推（或有效性），则这样一个!!^a{derivation}系统是可靠的。每个像样的!!{derivation}系统都必须可靠；不可靠的!!{derivation}系统根本无用。毕竟，!!a{derivation}的全部目的就是提供对有效性或衍推的句法保证。我们将为我们介绍的!!{derivation}系统证明其可靠性。
