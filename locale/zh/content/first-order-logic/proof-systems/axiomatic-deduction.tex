...
逻辑的公理化!!{derivation}系统最早由戈特洛布·弗雷格在他 1879 年的 《概念文字》（\textit{Begriffsschrift}）中给出，正因如此，该书常被视为现代逻辑的开山之作。这些系统在\zhFullName{Alfred North Whitehead}{阿尔弗雷德·诺斯·怀特海}{怀特海}与\zhFullName{Bertrand Russell}{伯特兰·罗素}{罗素}的 《数学原理》（\textit{Principia Mathematica}）中，以及 1920 年代大卫·希尔伯特及其学生们那里得到了完善。它们因此常被称作「\zhFullName{Gottlob Frege}{戈特洛布·弗雷格}{弗雷格}系统」或「\zhFullName{David Hilbert}{大卫·希尔伯特}{希尔伯特}系统」。它们之所以非常通用，是因为往往很容易为一种逻辑找到公理系统。由于!!{derivation}的结构非常简单且只有一两条推理规则，所以也相对容易证明关于它们的结论。然而，它们在实践中很难使用，即难以找出并写出证明。
