...
\begin{lem}[\zhFirst{Lindenbaum}{林登鲍姆}引理]
...
\begin{proof}
  ...
  \Proves/ !A$），否则添加 $!C_i$。我们稍后将证明这是可行的。眼下，我们定义
  ...
  \Gamma_{n+1} = \begin{cases}
    \Gamma_n \cup \{!B_{i(n)}\} &
    \text{若 $\Gamma_n \cup \{!B_{i(n)}\} \Proves/ !A$} \\
  ...
  \Gamma'$ 必属于某个 $\Gamma_i$。令 $n$ 为其中最大者。
  ...
  因为若 $!B \lor !C \in \Gamma^*$，则也有 $\Gamma^* \Proves !B
