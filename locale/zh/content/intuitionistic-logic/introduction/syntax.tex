...
命题直觉主义逻辑的!!^{formula}由\emph{!!{propositional variable}}与命题常元~$\lfalse$，并借助\emph{逻辑联结词}构造而成。我们有：
...
\item 若 $!A$ 与 $!B$ 是!!{formula}，则 $(!A \land
  !B)$ 是!!a{formula}。

\item 若 $!A$ 与 $!B$ 是!!{formula}，则 $(!A \lor !B)$
  是!!a{formula}。

\item 若 $!A$ 与 $!B$ 是!!{formula}，则 $(!A \lif !B)$
  是!!a{formula}。
...
尽管 $\lnot$ 在正式处理时被视为一个缩写，我们有时仍会在定义中为~$\lnot$ 明确给出规则和子句，就好像它是初始符号一样。这样做主要是为了便于我们给出练习题。
