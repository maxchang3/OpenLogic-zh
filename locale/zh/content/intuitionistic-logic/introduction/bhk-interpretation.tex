...
对于直觉主义联结词，存在一种非形式的构造性解释，通常称为布劳威尔–海廷–科莫哥洛夫（Brouwer--Heyting--Kolmogorov）解释，即 BHK 解释。它运用「构造」这一概念，你可以把它想成是一种构造性证明。（在 BHK 解释中我们不使用「证明」一词，以免与形式推演系统中!!a{derivation}的概念相混淆。）基于这一直观概念，BHK 解释说明了直觉主义联结词的含义。
