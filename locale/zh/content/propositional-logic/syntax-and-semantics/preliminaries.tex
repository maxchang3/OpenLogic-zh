...
\begin{proof}
  设 $S$ 为所有具有性质~$P$ 的!!{formula}之全体。显然 $S \subseteq \Frm[L_0]$。$S$~满足 \olref[fml]{defn:formulas} 的全部条件：它包含所有原子!!{formula}，并且对所有!!{operator}封闭。$\Frm[L_0]$ 是满足这些条件的最小类，因此 $\Frm[L_0] \subseteq S$。于是 $\Frm[L_0] = S$，即每个!!{formula}都具有性质~$P$。
\end{proof}
