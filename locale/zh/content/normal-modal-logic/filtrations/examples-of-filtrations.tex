...
\begin{defn}
  ...
  \tagitem{prvBox}{\ollabel{defn:coarsest-Box}如果 $\Box!A \in \Gamma$
    且 $\mSat{M}{\Box!A}[u]$，那么
    $\mSat{M}{!A}[v]$\iftag{prvDiamond}{；}{。}}{}
  \tagitem{prvDiamond}{\ollabel{defn:coarsest-Diamond}如果 $\Diamond!A
    \in \Gamma$ 且 $\mSat{M}{!A}[v]$，那么
    $\mSat{M}{\Diamond!A}[u]$。}{}
  \end{tagenumerate}
\end{defn}
...
\begin{ex}
  ...
  世界恰好可以及一个其他世界——即它的后继——且 $p$ 在所有偶数处且仅在
  偶数处为真。
