...
\olfileid[zh]{nml}{seq}{prk}

\olsection{\Log{K} 的矢列\usetoken{P}{derivation}}

\iftag{prvBox}{

\begin{ex}
  我们给出一个矢列演算的!!{derivation}，它表明 $\Proves (\Box!A \land \Box!B)
  \lif \Box (!A \land !B)$。
  \begin{prooftree}
    \Axiom$!A \fCenter !A$
    \doubleLine
...
\iftag{prvDiamond}{
  \begin{ex}
    我们给出一个矢列演算的!!{derivation}，它表明 $\Proves \Diamond(!A
