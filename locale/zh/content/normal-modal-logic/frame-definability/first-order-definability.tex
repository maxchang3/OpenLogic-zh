...
\end{equation}
\Ax{W} 定义传递且逆良基的框架类。若不存在无穷序列
$w_1$, $w_2$, \dots{} 使得 $Rw_2w_1$, $Rw_3w_2$, \dots，则一个关系是良基的。例如，$\Nat$~上的关系 $<$ 是良基的，而 $\Int$~上的关系 $<$ 则不是。一个关系是逆良基的，当且仅当其逆关系是良基的。因此，逆良基关系就是那些不存在无穷序列 $w_1$, $w_2$, \dots{}
