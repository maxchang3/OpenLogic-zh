...
模态逻辑 \Log{S5} 可刻画为在所有全域框架上都有效的!!{formula}的集合，即每一世界都可从任何其他世界（包括其自身）可及。在这样的情形下，$\Box$ 对应必然性，$\Diamond$ 对应可能性：若 $!A$ 在\emph{每一}世界处都为真，则 $\Box !A$ 为真；若 $!A$ 在\emph{某一}世界处为真，则 $\Diamond !A$ 为真。结果证明，\Log{S5} 也可刻画为在所有自反、对称且传递的框架上都有效的!!{formula}，即在所有\emph{等价关系}上都有效。
