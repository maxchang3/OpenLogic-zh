...
\begin{proof}
  ...
  若~$!B$ 的!!{derivation}长度为~$1$，则它只含一个!!{formula}。该!!{formula}不可能是由 \MP{} 或 \Nec 从先前公式得到的，因此它必然是一个重言式特例、\Ax{K} 或 \iftag{prvDiamond}{$\Dual$、}{}$!A_1$、\dots、~$!A_n$ 之一的特例。而 $\Log{K}!A_1\dots!A_n$ 也含有这些，故 $!B \in \Log{K}!A_1 \dots !A_n$。
