...
这个直觉性的理论可以与形式化语义配对，用于反事实逻辑。\zhFullName{David K. Lewis}{大卫·刘易斯}{刘易斯}引入符号「$\boxright$」表示反事实条件句，而\zhFullName{Robert Stalnaker}{罗伯特·斯达内克}{斯达内克}使用符号~「$>$」。使用~$\cif$，并将其作为二元联结词添加到命题逻辑中。于是，除了形如 $!A \lif
