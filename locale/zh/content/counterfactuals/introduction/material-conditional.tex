...
联结词 $\lif$ 是\emph{真值函项的}，即 $!A \lif !B$ 的真值——$\True$ 或 $\False$——由 $!A$ 和~$!B$ 的真值决定：当 $!A$ 为假或 $!B$ 为真时，$!A \lif !B$ 为真，否则为假。相对于真值指派~$\pAssign v$，定义 $\pSat{v}{!A \lif !B}$ 当且仅当 $\pSat/{v}{!A}$ 或 $\pSat{v}{!B}$。具有这种语义的联结词 $\lif$ 被称为\emph{实质条件句}。
